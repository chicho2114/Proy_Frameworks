 ...
 */
class ContEmergencia extends \Admin\AdminBundle\Entity\ContEmergencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContEmergencia $proxy) {
