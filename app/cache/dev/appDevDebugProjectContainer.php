...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAdminAdmin_Admin_ContEmergenciaService()
    {
        ...
        $instance->setLabel('Contactos Emergencia');
