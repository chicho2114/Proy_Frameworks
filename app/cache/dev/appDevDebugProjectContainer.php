...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin_admin.admin.paciente', 1 => 'admin_admin.admin.telefono', 2 => 'sonata.user.admin.user', 3 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('admin' => array('label' => 'admin', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'admin_admin.admin.paciente', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'admin_admin.admin.telefono', 'label' => '', 'route' => '', 'route_params' => array()))), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.user.admin.user', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.user.admin.group', 'label' => '', 'route' => '', 'route_params' => array())))));
        $instance->setAdminClasses(array('Admin\\AdminBundle\\Entity\\Paciente' => array(0 => 'admin_admin.admin.paciente'), 'Admin\\AdminBundle\\Entity\\Telefono' => array(0 => 'admin_admin.admin.telefono'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin_admin.admin.paciente', 1 => 'admin_admin.admin.telefono', 2 => 'sonata.user.admin.user', 3 => 'sonata.user.admin.group'), $this);
    }
